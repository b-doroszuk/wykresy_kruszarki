...
def main():
    ...
    filepath = "C:\\Users\\Jakub\\PycharmProjects\\test2\\testownik11_prof_Robert_Krol\\projekt_2\\POLKOWICE_etap_2" \
               "\\simulation_0\\simulation_0.dem "
    ...
    for i in range(interval_table[0], interval_table[1], interval_table[2]):
        ...
        tab_1, tab_2, char_80, char_50, thick_15 = test_object.prepate_data(1)
    ...
    fake_object.test_draw(tab_1=export_3_table[0], tab_2=export_3_table[1], char_80=export_3_table[2],
                          char_50=export_3_table[3], thick_15=export_3_table[4],
                          ...
                          tab_1_3=export_table[0], tab_2_3=export_table[1], char_80_3=export_table[2],
                          char_50_3=export_table[3], thick_15_3=export_table[4])
